...
const CHANNEL_PERMISSIONS = {
  ...
  'purchase:new':PERMISSIONS.INVENTORY_MANAGE,'purchase:add-item':PERMISSIONS.INVENTORY_MANAGE,'purchase:remove-item':PERMISSIONS.INVENTORY_MANAGE,'purchase:set-discount':PERMISSIONS.INVENTORY_MANAGE,'purchase:pay':PERMISSIONS.INVENTORY_MANAGE,'purchase:get':PERMISSIONS.INVENTORY_MANAGE,'purchase:list-open':PERMISSIONS.INVENTORY_MANAGE,'purchase:list-received':PERMISSIONS.INVENTORY_MANAGE,'purchase:payments':PERMISSIONS.INVENTORY_MANAGE,'purchase:returns':PERMISSIONS.INVENTORY_MANAGE,'purchase:return':PERMISSIONS.INVENTORY_MANAGE,
...
ipcMain.handle('purchase:list-received', () => rows("SELECT pi.*,s.name supplier_name FROM purchase_invoices pi JOIN suppliers s ON s.id=pi.supplier_id WHERE pi.status='RECEIVED' ORDER BY pi.purchase_no DESC"));
...
ipcMain.handle('invoice:pay', (_e, payload) => salesCore.invoicePay(payload));
