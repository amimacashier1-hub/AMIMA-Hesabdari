...
const CHANNEL_PERMISSIONS = {
  ...
  'purchase:new':PERMISSIONS.INVENTORY_MANAGE,'purchase:add-item':PERMISSIONS.INVENTORY_MANAGE,'purchase:remove-item':PERMISSIONS.INVENTORY_MANAGE,'purchase:set-discount':PERMISSIONS.INVENTORY_MANAGE,'purchase:pay':PERMISSIONS.INVENTORY_MANAGE,'purchase:get':PERMISSIONS.INVENTORY_MANAGE,'purchase:list-open':PERMISSIONS.INVENTORY_MANAGE,'purchase:payments':PERMISSIONS.INVENTORY_MANAGE,'purchase:returns':PERMISSIONS.INVENTORY_MANAGE,'purchase:return':PERMISSIONS.INVENTORY_MANAGE,
